...
const viewEmployeesByManager = async () => {
  ...
  try {
    const result: QueryResult = await pool.query('SELECT * FROM employees WHERE manager_id = $1', [manager_id]);
    console.table(result.rows);
  } catch (err) {
    console.error(err);
  } finally {
...
const viewEmployeesByDepartment = async () => {
  ...
  try {
    const result: QueryResult = await pool.query('SELECT * FROM employees WHERE department_id = $1', [department_id]);
    console.table(result.rows);
  } catch (err) {
    console.error(err);
  } finally {
...
const viewDepartmentBudget = async () => {
  ...
  try {
    const result: QueryResult = await pool.query('SELECT SUM(salary) FROM roles WHERE department_id = $1', [department_id]);
    console.table(result.rows);
  } catch (err) {
    console.error(err);
  } finally {
